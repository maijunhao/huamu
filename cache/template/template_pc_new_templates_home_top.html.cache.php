...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo HOME_THEME_PATH; ?>css/aswiper.min.css" />
    <link rel="stylesheet" type="text/css" href="<?php echo HOME_THEME_PATH; ?>css/animate.min.css" />
    <link rel="stylesheet" type="text/css" href="<?php echo HOME_THEME_PATH; ?>css/layout.css" />
    <script type="text/javascript" src="<?php echo HOME_THEME_PATH; ?>js/jquery-1.12.4.min.js"></script>

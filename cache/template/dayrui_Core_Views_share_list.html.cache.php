...
<script type="text/javascript">
    ...
    function dr_module_delete() {
        ...
        layer.open({
            ...
            shadeClose: true,
            shade: 0,
            area: [<?php echo !\Phpcmf\Service::C()->_is_mobile() ? '\'50%\', \'60%\'' : '"95%", "90%"' ?>],
            btn: [lang['ok']],
        ...
        <div class="col-md-12 col-sm-12">
            <label>
                <select name="field" class="form-control">
                    ...
                    <?php if (is_array($field)) { $key_t=-1;$count_t=dr_count($field);foreach ($field as $t) { $key_t++;  if (dr_is_admin_search_field($t)) { ?>
